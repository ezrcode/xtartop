...
function SubmitButton({ actionName, label, icon: Icon, variant = "primary" }: any) {
    ...
    const variants = {
        primary: "text-white bg-xtartop-black hover:bg-gray-900 focus:ring-xtartop-black",
        secondary: "text-dark-slate bg-white border border-graphite-gray hover:bg-gray-50 focus:ring-founder-blue",
...
export function ContactForm({ contact, companies, isEditMode = false }: ContactFormProps) {
    ...
    // Wrapper for update action to bind ID
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-3">
                            {/* We need to wrap buttons in the form to submit it. 
                   But the form is below. 
                   We can use the `form` attribute on buttons if the form has an ID.
               */}
                            <button
                                type="submit"
                                form="contact-form"
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    ...
                                    <div className="sm:col-span-6 flex items-center space-x-4">
                                        ...
                                        {/* <input type="hidden" name="photoUrl" ... /> Future implementation */}
