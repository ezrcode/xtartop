    ...
    return (
        <div className="bg-[var(--card-bg)] rounded-xl border border-[var(--card-border)] p-4 sm:p-5">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
                <div className="p-2.5 sm:p-3 bg-info-blue/10 rounded-xl">
                ...
                <div className="p-2.5 sm:p-3 bg-warning-amber/10 rounded-xl">
                    <div className="flex items-center gap-1.5 mb-1">
                ...
                <div className="p-2.5 sm:p-3 bg-success-green/10 rounded-xl">
                    <div className="flex items-center gap-1.5 mb-1">
