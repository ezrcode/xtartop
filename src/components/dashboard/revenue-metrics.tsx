        ...
        <div className="bg-white rounded-xl border border-graphite-gray p-4 sm:p-5">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
                ...
                <div className="p-2.5 sm:p-3 bg-blue-50 rounded-xl">
                    ...
                    <div className="text-[9px] sm:text-[10px] text-blue-500">Mensual recurrente</div>
                </div>
                ...
                <div className="p-2.5 sm:p-3 bg-purple-50 rounded-xl">
                    ...
                    <div className="text-[9px] sm:text-[10px] text-purple-500">Anual recurrente</div>
                </div>
                ...
                <div className="p-2.5 sm:p-3 bg-amber-50 rounded-xl">
                    ...
                    <div className="text-[9px] sm:text-[10px] text-amber-500">En negociación</div>
                </div>
                ...
                <div className="p-2.5 sm:p-3 bg-green-50 rounded-xl">
                    ...
                    <div className="text-[9px] sm:text-[10px] text-green-500">Cierres exitosos</div>
                </div>
            </div>
        </div>
    );
